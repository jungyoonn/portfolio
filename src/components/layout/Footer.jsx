          ...
          <div className="row mb-4">
            <div className="col-12">
              <div className="d-flex flex-wrap justify-content-center">
                {isHomePage ? (
                  <>
                    <a href="#home" onClick={(e) => scrollToSection(e, 'home')} className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Home</a>
                    <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="btn btn-sm btn-outline-light m-1 noto-sans-kr">About</a>
                    <a href="#projects" onClick={(e) => scrollToSection(e, 'projects')} className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Projects</a>
                    <a href="#timeline" onClick={(e) => scrollToSection(e, 'timeline')} className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Timeline</a>
                    <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Contact</a>
                  </>
                ) : (
                  <>
                    <a href="/#home" className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Home</a>
                    <a href="/#about" className="btn btn-sm btn-outline-light m-1 noto-sans-kr">About</a>
                    <a href="/#projects" className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Projects</a>
                    <a href="/#timeline" className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Timeline</a>
                    <a href="/#contact" className="btn btn-sm btn-outline-light m-1 noto-sans-kr">Contact</a>
                  </>
                )}
              </div>
            </div>
