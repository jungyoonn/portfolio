...
public:
  ...
  journeyEvents: [
    ...
    },
    {
      ...
      description: '졸업 후 교육 기관에서 3개월 훈련을 거쳐 클라우드 IT 회사에 입사했고, 기획자로서 프로젝트 초기 설계 및 분석 단계에 참여하여 클라우드 환경으로의 마이그레이션, AS-IS 기능 분석 및 TO-BE 기능 설계, 요구사항 정의, 화면 설계 등 이해관계자와의 커뮤니케이션 능력과 설계/분석 능력을 키웠습니다.',
    ...
    },
    {
      ...
      description: '프로젝트의 기획/설계에서 더 나아가 개발 단계까지, 내가 진정으로 잘할 수 있고 장기적으로 성장할 수 있는 분야에 대해 고민하는 과정에서 개발자로의 커리어 전환이 필요하다고 판단하여 퇴사 후 자격증 준비와 동시에 JAVA, Spring Framework를 학습하고, 첫 시작인 공지사항 게시판 애플리케이션을 개발하며 웹 개발의 기초를 다졌습니다.',
      iconType: 'server',
    ...
    },
    {
      ...
      date: '2025.04 ~ ',
      title: '지속적인 학습',
      description: '교육 과정 수료 후 현재는 수료 동기들과 함께 새로운 프로젝트를 진행 중이며, 클라우드 기술, 모바일 개발, 현대적인 프론트엔드 프레임워크에 대한 지식을 확장하고 있습니다.',
      iconType: 'mobileAlt',
      technologies: ['React Native', 'Docker', 'GitHub Action', 'Kubernetes', 'CI/CD', 'Kotlin'],
    },
  ],
  // Skills.jsx
  skills: [
